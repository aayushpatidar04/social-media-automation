        ...
        >
            ...
            <div class="mb-12">
                ...
                <p class="text-slate-400">
                    Real-time social media insights powered by AI
                </p>
            </div>
            ...
            <div v-if="loading" class="text-center py-12">
                <div class="inline-block">
                    <div
                        class="w-8 h-8 border-4 border-slate-600 border-t-blue-500 rounded-full animate-spin"
                    ></div>
                </div>
            ...
            <div v-else>
                <!-- Summary Cards -->
                <div
                    class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4 mb-8"
                >
                    ...
                    <div class="dashboard-card">
                        ...
                        <p class="text-2xl font-bold text-emerald-400">
                            {{ metrics.summary.qualified_leads }}
                        </p>
                    </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                    ...
                    <div class="dashboard-card">
                        ...
                        <div class="space-y-3">
                            <div
                                v-for="(data, platform) in metrics.by_platform"
                                :key="platform"
                            >
                                <div class="flex justify-between text-sm mb-1">
                                    <span class="text-slate-300 capitalize">{{
                    ...
                    <div class="dashboard-card">
                        ...
                        <div class="space-y-3">
                            <div
                                v-for="(count, status) in metrics.lead_metrics
                                    .by_status"
                                :key="status"
                            >
                                <div class="flex justify-between text-sm mb-1">
                ...
                <div class="dashboard-card mb-6">
                    ...
                    <div class="flex items-end justify-between h-32 gap-2">
                        <div
                            v-for="(item, idx) in metrics.activity_timeline"
                            :key="idx"
                            class="flex-1 flex flex-col items-center group cursor-pointer"
                        >
                            <div
                                class="w-full bg-slate-700 rounded-t hover:bg-blue-600 transition-colors"
                                :style="{
                                    height:
                                        (item.count / maxActivityCount) * 100 +
                                        '%',
                                    minHeight: '20px',
                                }"
                            ></div>
                            ...
                            >
                            <span
                                class="text-xs text-slate-400 opacity-0 group-hover:opacity-100"
                                >{{ item.count }}</span
                            >
                        </div>
                    </div>
                ...
                <div class="dashboard-card">
                    ...
                    >
                        <p class="text-slate-400">
                            No comments yet. Connect your first social account
                            to get started!
                        </p>
                        <a
                    ...
                    <div v-else class="space-y-4">
                        ...
                        >
                            <div class="flex justify-between items-start mb-2">
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <span
                                        class="px-2 py-1 rounded text-xs font-medium"
                                        :class="
                                            getIntentBadgeClass(comment.intent)
                                        "
                                    >
                                        {{ comment.intent }}
                                    </span>
                            ...
                            <p class="text-slate-300 text-sm mb-3 line-clamp-2">
                                {{ comment.content }}
                            </p>
                            <div
...
const recentComments = ref(page.props.recentComments || []);
...
onMounted(() => {
    ...
    const channel = pusher.subscribe(
        `analytics.org.${page.props.auth.user.organization_id}`,
    );
...
const getSentimentPercentage = (sentiment) => {
    const total = Object.values(metrics.value.sentiment_distribution).reduce(
